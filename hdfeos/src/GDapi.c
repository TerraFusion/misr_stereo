	 ...
	 float64 upleftpt[], float64 lowrightpt[])
{
	...
	if (ngridopen < NGRID)
	{
		...
		{
		    sprintf(refstr1, "%s%lf%s%lf%s",
			    "(", upleftpt[0], ",", upleftpt[1], ")");

		    sprintf(refstr2, "%s%lf%s%lf%s",
...
FCALLSCFUN2(INT32, GDopen, GDOPEN, gdopen, STRING, INT)
FCALLSCFUN6(INT32, GDcreate, GDCREATE, gdcreate, INT32, STRING,
	    INT32, INT32, DOUBLEV, DOUBLEV)
FCALLSCFUN2(INT32, GDattach, GDATTACH, gdattach, INT32, STRING)
FCALLSCFUN3(INT, GDdefdim, GDDEFDIM, gddefdim, INT32, STRING, INT32)
FCALLSCFUN5(INT, GDdefproj, GDDEFPROJ, gddefproj, INT32, INT32,
	    INT32, INT32, DOUBLEV)
FCALLSCFUN2(INT, GDdeforigin, GDDEFORIGIN, gddeforigin, INT32, INT32)
FCALLSCFUN2(INT, GDdefpixreg, GDDEFPREG, gddefpreg, INT32, INT32)
FCALLSCFUN5(INT, GDdeffld, GDDEFFLD, gddeffld, INT32, STRING, STRING,
	    INT32, INT32)
FCALLSCFUN3(INT, GDdefcomp, GDDEFCOMP, gddefcomp, INT32, INT32, INTV)
FCALLSCFUN4(INT, GDwrmeta, GDWRMETA, gdwrmeta, INT32, STRING, STRING,
	    INT32)
FCALLSCFUN6(INT, GDwrfld, GDWRFLD, gdwrfld, INT32, STRING, INT32V,
	    INT32V, INT32V, PVOID)
FCALLSCFUN6(INT, GDrdfld, GDRDFLD, gdrdfld, INT32, STRING, INT32V,
	    INT32V, INT32V, PVOID)
FCALLSCFUN3(INT, GDsetfillvalue, GDSETFILL, gdsetfill, INT32, STRING, PVOID)
FCALLSCFUN3(INT, GDgetfillvalue, GDGETFILL, gdgetfill, INT32, STRING, PVOID)
FCALLSCFUN5(INT, GDwriteattr, GDWRATTR, gdwrattr, INT32, STRING, INT32,
	    INT32, PVOID)
FCALLSCFUN3(INT, GDreadattr, GDRDATTR, gdrdattr, INT32, STRING, PVOID)
FCALLSCFUN4(INT, GDattrinfo, GDATTRINFO, gdattrinfo, INT32, STRING,
	    PINT32, PINT32)
...
FCALLSCFUN4(INT32, GDinqfields, GDINQFLDS, gdinqflds, INT32, PSTRING,
	    INT32V, INT32V)
FCALLSCFUN3(INT32, GDinqgrid, GDINQGRID, gdinqgrid, STRING, PSTRING,
	    PINT32)
FCALLSCFUN3(INT32, GDnentries, GDNENTRIES, gdnentries, INT32,
	    INT32, PINT32)
FCALLSCFUN2(INT32, GDdiminfo, GDDIMINFO, gddiminfo, INT32, STRING)
FCALLSCFUN5(INT, GDgridinfo, GDGRIDINFO, gdgridinfo, INT32, PINT32,
	    PINT32, DOUBLEV, DOUBLEV)
FCALLSCFUN5(INT, GDprojinfo, GDPROJINFO, gdprojinfo, INT32, PINT32,
	    PINT32, PINT32, DOUBLEV)
FCALLSCFUN6(INT, GDfldinfo, GDFLDINFO, gdfldinfo, INT32, STRING, PINT32,
	    INT32V, PINT32, PSTRING)
FCALLSCFUN2(INT32, GDorigininfo, GDORGINFO, gdorginfo, INT32,
	    PINT32)
FCALLSCFUN2(INT32, GDpixreginfo, GDPREGINFO, gdpreginfo, INT32,
	    PINT32)
FCALLSCFUN4(INT, GDcompinfo, GDCOMPINFO, gdcompinfo, INT32, STRING,
	    PINT32, INTV)
FCALLSCFUN3(INT32, GDdefboxregion, GDDEFBOXREG, gddefboxreg, INT32,
	    DOUBLEV, DOUBLEV)
FCALLSCFUN4(INT32, GDdefvrtregion, GDDEFVRTREG, gddefvrtreg, INT32,
	    INT32, STRING, DOUBLEV)
FCALLSCFUN4(INT32, GDdeftimeperiod, GDDEFTMEPER, gddeftmeper, INT32,
	    INT32, DOUBLE, DOUBLE)
FCALLSCFUN6(INT, GDgetpix, GDGETPIX, gdgetpix, INT32, INT32, DOUBLEV,
	    DOUBLEV, INT32V, INT32V)
FCALLSCFUN6(INT32, GDgetpixval, GDGETPIXVAL, gdgetpixval, INT32,
	    INT32, INT32V, INT32V, STRING, PVOID)
FCALLSCFUN6(INT32, GDinterpolate, GDINTERPOLATE, gdinterpolate, INT32,
	    INT32, DOUBLEV, DOUBLEV, STRING, DOUBLEV)
FCALLSCFUN9(INT, GDreginfo, GDREGINFO, gdreginfo, INT32, INT32, STRING,
	    PINT32, PINT32, INT32V, PINT32, DOUBLEV, DOUBLEV)
FCALLSCFUN4(INT, GDextractregion, GDEXTREG, gdextreg, INT32, INT32,
	    STRING, PVOID)
FCALLSCFUN1(INT32, GDdupregion, GDDUPREG, gddupreg, INT32)
FCALLSCFUN4(INT, GDdeftle, GDDEFTLE, gddeftle, INT32, INT32, INT32,
	    INT32V)
FCALLSCFUN4(INT, GDsettilecache, GDSETTLECHE, gdsettleche, INT32, STRING,
	    INT32, INT32)
FCALLSCFUN5(INT, GDtleinfo, GDTLEINFO, gdtleinfo, INT32, STRING, PINT32,
	    PINT32, INT32V)
FCALLSCFUN4(INT, GDwrtle, GDWRTLE, gdwrtle, INT32, STRING, INT32V,
	    PVOID)
FCALLSCFUN4(INT, GDrdtle, GDRDTLE, gdrdtle, INT32, STRING, INT32V,
	    PVOID)
FCALLSCFUN1(INT, GDdetach, GDDETACH, gddetach, INT32)
FCALLSCFUN1(INT, GDclose, GDCLOSE, gdclose, INT32)

FCALLSCFUN13(INT,GDrs2ll, GDRS2LL, gdrs2ll, INT32, DOUBLEV, \
	     INT32, INT32, DOUBLEV, DOUBLEV, \
	     INT32, DOUBLEV, DOUBLEV, DOUBLEV, DOUBLEV, INT32, INT32)
