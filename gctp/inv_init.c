...
*/
    ...
    *iflg = obleqinvint(radius,center_long,center_lat,shape_m, shape_n,
    ...
    ------------------------------------------------------------------ */
/*    if (inspheroid != 19 && inspheroid != 31 )
        sphdz(31,inparm,&r_major,&r_minor,&radius);
*/
